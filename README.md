...
<script>
  document.querySelectorAll(".thumbnails a").forEach(a => {
    a.addEventListener("mouseover", () => {
      a.querySelector("img").style.transform = "scale(1.05)";
      a.querySelector("div").style.opacity = "1";
    });
    a.addEventListener("mouseout", () => {
      a.querySelector("img").style.transform = "scale(1)";
      a.querySelector("div").style.opacity = "0";
    });
  });
</script>
