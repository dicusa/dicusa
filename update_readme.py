    ...
    try:
        ...
        for post in posts:
            new_content.append(
                ...
                f'    <img src="{post["thumbnail"]}" alt="{post["title"]}" style="height:150px; object-fit: cover; width: 100px; border-radius: 10px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); transition: transform 0.2s;">\n'
                f'  </a>\n'
            )
